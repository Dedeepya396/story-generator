...
//     return Scaffold(
//     //   appBar: AppBar(
//     //     // title: Text('TinyTales'),
//     //     backgroundColor: Colors.blue[50],
//     //     actions: [
//     //       TextButton(
//     //         onPressed: () => Navigator.pushNamed(context, '/'),
//     //         child: Text('Home', style: TextStyle(color: Colors.blue[900], fontSize:30)),
//     //       ),
//     //       TextButton(
//     //         onPressed: () => Navigator.pushNamed(context, '/about'),
//     //         child: Text('About', style: TextStyle(color: Colors.blue[900], fontSize:30)),
//     //       ),
//     //       TextButton(
//     //         onPressed: () => Navigator.pushNamed(context, '/login'),
//     //         child: Text('Login', style: TextStyle(color: Colors.blue[900], fontSize:30)),
//     //       ),
//     //       TextButton(
//     //         onPressed: () => Navigator.pushNamed(context, '/profile'),
//     //         child: Text('Profile', style: TextStyle(color: Colors.blue[900], fontSize:30)),
//     //       ),
//     //     ],
...
//                             fontSize: 36,
//                             fontWeight: FontWeight.bold,
//                             color: Colors.white, // White for contrast over dark overlay
//                         ),
//                         ),
//                         SizedBox(height: 50),
//                         Wrap(
